<template>
  <div :class="['ctp-pro-kanban-board', `ctp-pro-kanban-board--${color}`, className]">
    ...
    >
      ...
      />
      <div v-else class="ctp-pro-kanban-column-header">
        <div class="ctp-pro-kanban-column-title-container">
          <span class="ctp-pro-kanban-column-dot" />
      ...
      <div class="ctp-pro-kanban-cards-container">
        <div
          ...
          :class="[
            'ctp-pro-kanban-card',
            draggedItem?.id === item.id ? 'ctp-pro-kanban-card--dragging' : '',
          ]"
        ...
        >
          ...
          <template v-else>
            ...
            <div v-if="item.description" class="ctp-pro-kanban-card-desc">
              {{ item.description }}
            </div>
            <div v-if="item.tags && item.tags.length > 0" class="ctp-pro-kanban-card-tags">
              <span
                v-for="tag in item.tags"
                :key="tag"
                class="ctp-pro-kanban-card-tag"
              >
                {{ tag }}
              </span>
            </div>
        ...
        <div
          ...
          class="ctp-pro-kanban-empty-column-placeholder"
        >
          Solte itens aqui
        </div>
      </div>
