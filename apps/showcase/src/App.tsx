...
const colors: ColorInfo[] = [
  { name: 'Rosewater', variable: '--ctp-rosewater', hexCodes: { macchiato: '#f4dbd6', mocha: '#f5e0dc', frappe: '#f2d5cf', latte: '#dc8a78' } },
  { name: 'Flamingo', variable: '--ctp-flamingo', hexCodes: { macchiato: '#f0c6c6', mocha: '#f2cdcd', frappe: '#eebebe', latte: '#dd7878' } },
  { name: 'Pink', variable: '--ctp-pink', hexCodes: { macchiato: '#f5bde6', mocha: '#f5c2e7', frappe: '#f4b8e4', latte: '#ea76cb' } },
  { name: 'Mauve', variable: '--ctp-mauve', hexCodes: { macchiato: '#c6a0f6', mocha: '#cba6f7', frappe: '#ca9ee6', latte: '#8839ef' } },
  { name: 'Red', variable: '--ctp-red', hexCodes: { macchiato: '#ed8796', mocha: '#f38ba8', frappe: '#e78284', latte: '#d20f39' } },
  { name: 'Maroon', variable: '--ctp-maroon', hexCodes: { macchiato: '#ee99a0', mocha: '#eba0ac', frappe: '#ea999c', latte: '#e64553' } },
  { name: 'Peach', variable: '--ctp-peach', hexCodes: { macchiato: '#f5a97f', mocha: '#fab387', frappe: '#ef9f76', latte: '#fe640b' } },
  { name: 'Yellow', variable: '--ctp-yellow', hexCodes: { macchiato: '#eed49f', mocha: '#f9e2af', frappe: '#e5c890', latte: '#df8e1d' } },
  { name: 'Green', variable: '--ctp-green', hexCodes: { macchiato: '#a6da95', mocha: '#a6e3a1', frappe: '#a6d189', latte: '#40a02b' } },
  { name: 'Teal', variable: '--ctp-teal', hexCodes: { macchiato: '#8bd5ca', mocha: '#94e2d5', frappe: '#81c8be', latte: '#179287' } },
  { name: 'Sky', variable: '--ctp-sky', hexCodes: { macchiato: '#91d7e3', mocha: '#89dceb', frappe: '#99d1db', latte: '#04a5e5' } },
  { name: 'Sapphire', variable: '--ctp-sapphire', hexCodes: { macchiato: '#7dc4e4', mocha: '#74c7ec', frappe: '#85c1dc', latte: '#209fb5' } },
  { name: 'Blue', variable: '--ctp-blue', hexCodes: { macchiato: '#8aadf4', mocha: '#89b4fa', frappe: '#8caaee', latte: '#1e66f5' } },
  { name: 'Lavender', variable: '--ctp-lavender', hexCodes: { macchiato: '#b7bdf8', mocha: '#b4befe', frappe: '#babbf1', latte: '#7287fd' } },
];
...
export default function App() {
  ...
  const getAngularSelectCode = () => {
    return `<span class="hl-tag">&lt;ctp-multi-select</span> <span class="hl-attr">[options]</span>=<span class="hl-str">"options"</span> <span class="hl-attr">[(value)]</span>=<span class="hl-str">"selectedValues"</span> <span class="hl-attr">color</span>=<span class="hl-str">"${selectAccent}"</span> <span class="hl-attr">size</span>=<span class="hl-str">"${selectSize}"</span> <span class="hl-attr">shape</span>=<span class="hl-str">"${selectShape}"</span><span class="hl-tag">&gt;&lt;/ctp-multi-select&gt;</span>`;
  };
  ...
  const getReactIconCode = () => {
    const classProp = iconHoverEffect !== 'none' ? ` className="ctp-icon--hover-${iconHoverEffect}"` : '';
  ...
  const getVueIconCode = () => {
    const classProp = iconHoverEffect !== 'none' ? ` class="ctp-icon--hover-${iconHoverEffect}"` : '';
    const colorProp = iconColor !== 'text' ? ` color="${iconColor}"` : '';
  ...
  const getAngularGridCode = () => {
    return `<span class="hl-tag">&lt;ctp-grid</span> <span class="hl-attr">[gap]</span>=<span class="hl-str">"${gridGap}"</span> <span class="hl-attr">[mobile]</span>=<span class="hl-str">"${gridMobile}"</span> <span class="hl-attr">[multiline]</span>=<span class="hl-str">"${gridMultiline}"</span> <span class="hl-attr">align</span>=<span class="hl-str">"${gridAlign}"</span> <span class="hl-attr">valign</span>=<span class="hl-str">"${gridValign}"</span><span class="hl-tag">&gt;</span>\n  <span class="hl-tag">&lt;div</span> <span class="hl-attr">ctpGridCol</span> <span class="hl-attr">[span]</span>=<span class="hl-str">"12"</span><span class="hl-tag">&gt;</span>Largura total (12/12)<span class="hl-tag">&lt;/div&gt;</span>\n  <span class="hl-tag">&lt;div</span> <span class="hl-attr">ctpGridCol</span> <span class="hl-attr">[span]</span>=<span class="hl-str">"6"</span><span class="hl-tag">&gt;</span>Metade (6/12)<span class="hl-tag">&lt;/div&gt;</span>\n  <span class="hl-tag">&lt;div</span> <span class="hl-attr">ctpGridCol</span> <span class="hl-attr">[span]</span>=<span class="hl-str">"6"</span><span class="hl-tag">&gt;</span>Metade (6/12)<span class="hl-tag">&lt;/div&gt;</span>\n<span class="hl-tag">&lt;/ctp-grid&gt;</span>`;
  };
  ...
  const getAngularDropdownCode = () => {
    return `<span class="hl-tag">&lt;ctp-dropdown</span> <span class="hl-attr">placement</span>=<span class="hl-str">"${dropdownPlacement}"</span> <span class="hl-attr">color</span>=<span class="hl-str">"${dropdownColor}"</span><span class="hl-tag">&gt;</span>\n  <span class="hl-tag">&lt;button</span> <span class="hl-attr">ctp-button</span> <span class="hl-attr">dropdownTrigger</span><span class="hl-tag">&gt;</span>Abrir Menu<span class="hl-tag">&lt;/button&gt;</span>\n  <span class="hl-tag">&lt;ctp-dropdown-header&gt;</span>Ações do Usuário<span class="hl-tag">&lt;/ctp-dropdown-header&gt;</span>\n  <span class="hl-tag">&lt;ctp-dropdown-item&gt;</span>Meu Perfil<span class="hl-tag">&lt;/ctp-dropdown-item&gt;</span>\n  <span class="hl-tag">&lt;ctp-dropdown-divider&gt;&lt;/ctp-dropdown-divider&gt;</span>\n  <span class="hl-tag">&lt;ctp-dropdown-item</span> <span class="hl-attr">[danger]</span>=<span class="hl-str">"true"</span><span class="hl-tag">&gt;</span>Excluir Conta<span class="hl-tag">&lt;/ctp-dropdown-item&gt;</span>\n<span class="hl-tag">&lt;/ctp-dropdown&gt;</span>`;
  };
...
<span class="hl-tag">/&gt;</span>`;
  ...
  const getAngularPaginationCode = () => {
    return `<span class="hl-tag">&lt;ctp-pagination</span>
  <span class="hl-attr">[currentPage]</span>=<span class="hl-str">"page"</span>
  <span class="hl-attr">[totalPages]</span>=<span class="hl-str">"totalPages"</span>
  ...
  <span class="hl-attr">color</span>=<span class="hl-str">"${paginationColor}"</span>
  <span class="hl-attr">[showPageInput]</span>=<span class="hl-str">"${paginationShowPageInput}"</span>
<span class="hl-tag">&gt;&lt;/ctp-pagination&gt;</span>

<span class="hl-tag">&lt;ctp-page-size-selector</span>
  <span class="hl-attr">[pageSize]</span>=<span class="hl-str">"limit"</span>
...
<span class="hl-tag">&lt;/CtpBadge&gt;</span>`;
  ...
  const getAngularBadgeCode = () => {
    return `<span class="hl-tag">&lt;ctp-badge</span>
  <span class="hl-attr">variant</span>=<span class="hl-str">"${badgeVariant}"</span>
  <span class="hl-attr">size</span>=<span class="hl-str">"${badgeSize}"</span>
  <span class="hl-attr">shape</span>=<span class="hl-str">"${badgeShape}"</span>
  <span class="hl-attr">color</span>=<span class="hl-str">"${badgeColor}"</span>
...
<span class="hl-tag">&lt;/ctp-badge&gt;</span>`;
  };
...
<span class="hl-tag">&lt;CtpTile</span> <span class="hl-attr">variant</span>=<span class="hl-str">"tonal"</span> <span class="hl-attr">color</span>=<span class="hl-str">"peach"</span> <span class="hl-attr">indicator</span>=<span class="hl-str">"left"</span> <span class="hl-attr">title</span>=<span class="hl-str">"System Load"</span> <span class="hl-attr">subtitle</span>=<span class="hl-str">"Operational"</span> <span class="hl-tag">/&gt;</span>`;
  ...
  const getAngularCardCode = () => {
    return `<span class="hl-tag">&lt;ctp-card</span> <span class="hl-attr">variant</span>=<span class="hl-str">"filled"</span> <span class="hl-attr">[accentColor]</span>=<span class="hl-str">"'mauve'"</span> <span class="hl-attr">accentPosition</span>=<span class="hl-str">"top"</span> <span class="hl-attr">[isInteractive]</span>=<span class="hl-str">"true"</span><span class="hl-tag">&gt;</span>
  <span class="hl-tag">&lt;ctp-card-header</span> <span class="hl-attr">title</span>=<span class="hl-str">"Card Title"</span> <span class="hl-attr">subtitle</span>=<span class="hl-str">"Card Subtitle"</span><span class="hl-tag">&gt;&lt;/ctp-card-header&gt;</span>
  <span class="hl-tag">&lt;ctp-card-body&gt;</span>
    <span class="hl-text">Card Content...</span>
  <span class="hl-tag">&lt;/ctp-card-body&gt;</span>
  <span class="hl-tag">&lt;ctp-card-footer&gt;</span>
    <span class="hl-tag">&lt;button</span> <span class="hl-attr">ctp-button</span><span class="hl-tag">&gt;</span>Action<span class="hl-tag">&lt;/button&gt;</span>
  <span class="hl-tag">&lt;/ctp-card-footer&gt;</span>
<span class="hl-tag">&lt;/ctp-card&gt;</span>

<span class="hl-tag">&lt;ctp-tile</span> <span class="hl-attr">variant</span>=<span class="hl-str">"tonal"</span> <span class="hl-attr">color</span>=<span class="hl-str">"peach"</span> <span class="hl-attr">indicator</span>=<span class="hl-str">"left"</span> <span class="hl-attr">title</span>=<span class="hl-str">"System Load"</span> <span class="hl-attr">subtitle</span>=<span class="hl-str">"Operational"</span><span class="hl-tag">&gt;&lt;/ctp-tile&gt;</span>`;
  };
...
<span class="hl-tag">/&gt;</span>`;
  ...
  const getAngularTableCode = () => {
    return `<span class="hl-tag">&lt;ctp-table</span>
  <span class="hl-attr">[data]</span>=<span class="hl-str">"employees"</span>
  <span class="hl-attr">[columns]</span>=<span class="hl-str">"columns"</span>
  ...
  <span class="hl-attr">size</span>=<span class="hl-str">"${tableSize}"</span>
  <span class="hl-attr">color</span>=<span class="hl-str">"${tableColor}"</span>
<span class="hl-tag">&gt;&lt;/ctp-table&gt;</span>`;
  };
          ...
          <Shell.Header style={{ justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              <button
                ...
                className="ctp-d--none ctp-d--inline-flex-mobile"
              >
                ☰
              </button>
      ...
      <aside className={`showcase-sidebar ${isSidebarOpen ? 'open' : ''}`}>
        ...
        <div className="sidebar-theme-wrapper">
          <div className="theme-selector">
            {(['latte', 'frappe', 'macchiato', 'mocha'] as const).map((t) => (
              <button
                key={t}
